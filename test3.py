...
# 对所有valid_10的游戏进行测试
def run():
    game_paths = get_cv_games(path= '/home/zhuobinggang/research/datasets/ftwp/games', split = 'fake_valid_10')
    for game_path in game_paths:
        game1 = game_command_generate.Game_command_generate(game_path)
